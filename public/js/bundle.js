...
var DogActions = function () {
  function DogActions() {
    _classCallCheck(this, DogActions);

    this.generateActions('getDogSuccess');
  }

  _createClass(DogActions, [{
    key: 'getDog',
    value: function getDog(id) {
      var _this = this;

      _superagent2.default.get('/api/dog/' + id).end(function (err, response) {
        _this.actions.getDogSuccess(response.body);
      });
    }
  }]);
...
var DogAddActions = function () {
  function DogAddActions() {
    _classCallCheck(this, DogAddActions);

    this.generateActions('addDogSuccess');
  }

  _createClass(DogAddActions, [{
    key: 'addDog',
    value: function addDog(dog) {
      var _this = this;

      _superagent2.default.post('/api/dog/add').send({ dog: dog }).end(function (err, response) {
        _this.actions.addDogSuccess(response);
      });
    }
  }]);

  return DogAddActions;
}();
...
var _DogActions = require('../../actions/DogActions');

var _DogActions2 = _interopRequireDefault(_DogActions);

var _DogStore = require('../../stores/DogStore');

var _DogStore2 = _interopRequireDefault(_DogStore);
...
var Dog = function (_React$Component) {
  ...
  function Dog(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Dog).call(this, props));

    _this.state = _DogStore2.default.getState();
  ...
  _createClass(Dog, [{
    ...
    value: function componentDidMount() {
      _DogStore2.default.listen(this.onChange);
      _DogActions2.default.getDog(this.props.params.id);
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _DogStore2.default.unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
...
var _DogAddActions = require('../../actions/DogAddActions');

var _DogAddActions2 = _interopRequireDefault(_DogAddActions);

var _DogAddStore = require('../../stores/DogAddStore');

var _DogAddStore2 = _interopRequireDefault(_DogAddStore);
...
var DogAdd = function (_React$Component) {
  _inherits(DogAdd, _React$Component);

  function DogAdd(props) {
    _classCallCheck(this, DogAdd);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DogAdd).call(this, props));

    _this.state = _DogAddStore2.default.getState();
    _this.onChange = _this.onChange.bind(_this);
    return _this;
  }
  ...
  _createClass(DogAdd, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _DogAddStore2.default.listen(this.onChange);
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _DogAddStore2.default.unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
    value: function onChange(state) {
...
var _DogListActions = require('../../actions/DogListActions');

var _DogListActions2 = _interopRequireDefault(_DogListActions);

var _DogListStore = require('../../stores/DogListStore');
...
var DogList = function (_React$Component) {
  _inherits(DogList, _React$Component);

  function DogList(props) {
    _classCallCheck(this, DogList);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DogList).call(this, props));

    _this.state = _DogListStore2.default.getState();
    _this.onChange = _this.onChange.bind(_this);
    return _this;
  }
  ...
  _createClass(DogList, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _DogListStore2.default.listen(this.onChange);
      _DogListActions2.default.getDogs();
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _DogListStore2.default.unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
    value: function onChange(state) {
...
var _DogAdd = require('./components/Dog/DogAdd');

var _DogAdd2 = _interopRequireDefault(_DogAdd);

var _DogList = require('./components/Dog/DogList');
...
exports.default = _react2.default.createElement(
  ...
  _react2.default.createElement(_reactRouter.Route, { path: '/dog/add', component: _DogAdd2.default }),
  _react2.default.createElement(_reactRouter.Route, { path: '/dog/:id', component: _Dog2.default }),
...
var DogAddStore = function () {
  function DogAddStore() {
...
var DogListStore = function () {
  function DogListStore() {
    _classCallCheck(this, DogListStore);

    this.bindActions(_DogListActions2.default);
    this.dogs = [];
  }

  _createClass(DogListStore, [{
...
var DogStore = function () {
  function DogStore() {
    _classCallCheck(this, DogStore);

    this.bindActions(_DogActions2.default);
    this.dog = [];
  }

  _createClass(DogStore, [{
    key: 'onGetDogSuccess',
    value: function onGetDogSuccess(data) {
      this.dog = data;
    }
  }]);
